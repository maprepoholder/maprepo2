			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    mul_sat_pp r0, r0, c1.z
					    add r1.yz, c1.w, -v2_abs.xxyw
					    mul r1.yz, r1, c0.xxyw
					    min_sat r2.x, r1.z, r1.y
				...
				SubProgram "d3d11 " {
					...
					add r1.yz, -|v2.zzwz|, l(0.000000, 1.000000, 1.000000, 0.000000)
					mul r1.yz, r1.yyzy, cb0[3].xxyx
