		...
		Pass {
			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					...
					mad r0.x, v0.x, cb0[7].w, -r0.x
					dp2 r0.y, v0.xyxx, cb0[7].zwzz
					mad o3.xy, r0.xyxx, cb0[6].zwzz, cb0[6].xyxx
					mov o4.xyzw, v3.xyzw
					ret 
			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    min r1.y, r0.y, r0.x
					    min r0.x, r1.x, r1.y
					    add r0.yz, c3.x, -v3_abs.xxyw
					    mul r0.yz, r0, c2.xxyw
					    min r1.x, r0.z, r0.y
					    min_sat r2.x, r1.x, r0.x
					    texld r0, v0, s0
					    mul_pp r0, r0, v4
				...
				SubProgram "d3d11 " {
					...
					min r0.x, r0.z, r0.x
					add r0.yz, -|v3.xxyx|, l(0.000000, 1.000000, 1.000000, 0.000000)
					mul r0.yz, r0.yyzy, cb0[7].xxyx
					min r0.y, r0.z, r0.y
