		...
		Pass {
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					dp3 r0.y, r3.xyzx, l(0.220000, 0.707000, 0.071000, 0.000000)
					add r0.x, -r0.y, r0.x
			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    ps_3_0
					    def c5, 1, -1, 0, 0.00150000001
					    def c6, 0.5, 4, 0.166666999, 2.71828198
					    def c7, 0.142857, 0.219999999, 0.707000017, 0.0710000023
					    def c8, 0.00200000009, -2, 3, 0.850000024
					    dcl_texcoord v0
					    dcl_2d s0
					    dcl_2d s1
					    dcl_2d s2
					    ...
					    texld r3, r1, s0
					    add r4.xyz, r3, r3
					    mad r1.zw, r2.xyxy, -c6.x, r1.xyxy
					    mad r1.xy, r2, c6.x, r1
					    texld_pp r5, r1, s0
					    texld_pp r1, r1.zwzw, s0
					    add r2.xyw, r5.xyzz, r1.xyzz
					    mad r2.xyw, r2, c6.y, -r4.xyzz
					    mad r4.xyz, r2.xyww, -c6.z, r3
					    mul r4.xyz, r4, c3.x
					    mad_pp r3.xyz, r4, c6.w, r3
					    max_pp r4.xyz, r3, c5.z
					    add r2.xyw, r2, r4.xyzz
					    mul_pp r2.xyw, r2, c7.x
					    max_pp r0.z, r2.y, r2.w
					    max_pp r1.w, r2.x, r0.z
					    add r0.z, r1.w, c5.x
					    rcp r0.z, r0.z
					    mul_pp r2.xyw, r0.z, r2
					    dp3_pp r0.z, r2.xyww, c7.yzww
					    max_pp r1.w, r4.y, r4.z
					    max_pp r2.x, r4.x, r1.w
					    add r1.w, r2.x, c5.x
					    rcp r1.w, r1.w
					    mul_pp r3.xyz, r1.w, r4
					    dp3_pp r1.w, r3, c7.yzww
					    add r0.z, r0.z, -r1.w
					    ...
					    mad r1.xyz, r0_abs.z, c6.y, r5
					    mad r2.xyw, r0_abs.z, -c6.y, r4.xyzz
					    add r4.xyz, r1, -r2.xyww
					    add r1.xyz, r1, r2.xyww
					    mul r1.xyz, r1, c6.x
					    mul r2.xyw, r4.xyzz, c6.x
					    rcp r4.x, r2.x
					    rcp r4.y, r2.y
					    rcp r4.z, r2.w
					    add r2.xy, -c1, v0.zwzw
					    texld r5, r2, s3
					    mad r2.xyw, r5.x, c5.zzzx, c5.yyzz
					    texld r6, v0.zwzw, s3
					    add r0.z, -r5.x, r6.x
					    mul r5.xyz, r6.x, c5.zzxw
					    cmp r2.xyw, r0.z, r2, r5.xyzz
					    mad r5.xy, c1, r0, v0.zwzw
					    texld r5, r5, s3
					    add r0.z, r2.w, -r5.x
					    mad r5.xyz, r5.x, c5.zzxw, c5
					    cmp r2.xyw, r0.z, r5.xyzz, r2
					    mad r0.xy, c1, r0.yxzw, v0.zwzw
					    texld r5, r0, s3
					    add r0.x, r2.w, -r5.x
					    mad r5.xyz, r5.x, c5.zzxw, c5.yxzw
					    cmp r0.xyz, r0.x, r5, r2.xyww
					    add r2.xy, c1, v0.zwzw
					    texld r5, r2, s3
					    add r0.z, r0.z, -r5.x
					    cmp r0.xy, r0.z, c5.x, r0
					    mad r0.xy, r0, c1, v0.zwzw
					    texld r5, r0, s2
					    add r0.xy, -r5, v0.zwzw
					    dp2add r0.z, r5, r5, c5.z
					    rsq r0.z, r0.z
					    rcp r0.z, r0.z
					    texld r5, r0, s1
					...
					// approximately 119 instruction slots used (10 texture, 109 arithmetic)"
				}
				SubProgram "d3d11 " {
					"!!DX11PixelSM40
					//
			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    def c6, 0.142857, 0.219999999, 0.707000017, 0.0710000023
