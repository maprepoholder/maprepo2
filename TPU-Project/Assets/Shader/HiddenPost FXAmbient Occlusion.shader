			...
			Program "fp" {
				...
				SubProgram "d3d9 " {
					...
					//
					    ...
					    def c13, 2, -1, 1, -0.999989986
					    def c14, 100000000, 0.0671105608, 0.00583714992, 0
					    def c15, 0, 1, 12.9898005, 78.2330017
					    def c16, 0.00200000009, 9.99999975e-005, 0.600000024, 0
					    def c17, 6.28318548, -3.14159274, 0.159154937, 0.5
					    def c18, 52.9829178, 12.451169, 0.5, 43758.5469
					    def c19, 0.5, -0.5, 0, 0
					    dcl_texcoord v0.xy
					    dcl_texcoord1 v1.xy
					    dcl_2d s0
					    ...
					    add r0.w, r0.z, r0.z
					    mul r1.yz, r1.xxyw, r0.w
					    mad r1.w, r0.z, c13.x, c13.y
					    mul_pp r2.xyz, r1.yzww, c13.zzyw
					    texld r3, r0, s0
					    mov r0.w, c12.w
					    add r0.z, r0.w, -c5.w
					    mul r1.x, r3.x, c4.x
					    ...
					    rcp r1.x, r1.x
					    mul r3.x, r1.x, r2.w
					    cmp r3.yz, r0.xxyw, c12.y, c12.w
					    dp2add r3.y, r3.yzzw, r3.yzzw, c12.y
					    cmp r3.y, -r3.y, c12.y, c12.w
					    add r0.xy, -r0, c12.w
					    cmp r0.xy, r0, c12.y, c12.w
					    dp2add r0.x, r0, r0, c12.y
					    cmp r0.x, -r0.x, c12.y, c12.w
					    add r0.x, r0.x, r3.y
					    mad r0.y, r2.w, r1.x, c13.w
					    cmp r0.y, r0.y, c12.w, c12.y
					    add r0.x, r0.y, r0.x
					    mul r0.x, r0.x, c14.x
					    mad r3.z, r3.x, c2.z, r0.x
					    ...
					    rep i0
					      ...
					      add r1.x, r0.x, r1.x
					      frc r1.x, r1.x
					      mad r6.z, r1.x, c13.x, c13.y
					      mad r5.zw, r4.w, c15.xyxy, c15.xyzx
					      dp2add r1.x, r5.zwzw, c15.ywzw, c15.x
					      mad r1.x, r1.x, c17.z, c17.w
					      frc r1.x, r1.x
					      mad r1.x, r1.x, c17.x, c17.y
					      sincos r7.y, r1.x
					      mul r1.x, r7.y, c18.w
					      ...
					      mul r6.xyz, r1.x, r6
					      dp3 r1.x, -r2, r6
					      cmp r1.x, r1.x, c12.w, c12.y
					      mul r7.xyz, r1.x, r6
					      mad r6.xyz, r7, -c13.x, r6
					      add r6.xyz, r3, r6
					      dp3 r7.x, c0, r6
					      dp3 r7.y, c1, r6
					      add r1.x, -r6.z, c12.w
					      ...
					      rcp r1.x, r1.x
					      mul r3.w, r1.x, r2.w
					      cmp r6.zw, r6.xyxy, c12.y, c12.w
					      dp2add r6.z, r6.zwzw, r6.zwzw, c12.y
					      add r6.xy, -r6, c12.w
					      cmp r6.xy, r6, c12.y, c12.w
					      dp2add r6.x, r6, r6, c12.y
					      cmp r6.xz, -r6, c12.y, c12.w
					      add r6.x, r6.x, r6.z
					      mad r1.x, r2.w, r1.x, c13.w
					      cmp r1.x, r1.x, c12.w, c12.y
					      add r1.x, r1.x, r6.x
					      mul r1.x, r1.x, c14.x
					      mad r6.z, r3.w, c2.z, r1.x
					    ...
					    pow r1.x, r0.x, c16.z
					    texld r0, v0, s0
					    mad r0.x, c4.x, r0.x, c4.y
					    rcp r0.x, r0.x
					    mad r0.x, r0.x, c2.z, -c2.y
					    add r0.x, -r0.x, c11.z
					    add r0.y, -c11.y, c11.z
					    rcp r0.y, r0.y
					    mul_sat_pp r0.x, r0.y, r0.x
					    mul_pp oC0.x, r0.x, r1.x
					    mad_pp oC0.yzw, r1, c19.xxxy, c19.x
					
					// approximately 176 instruction slots used (4 texture, 172 arithmetic)"
				}
				SubProgram "d3d11 " {
					Keywords { "FOG_LINEAR" }
					"!!DX11PixelSM40
					...
					mad r0.y, r0.y, cb1[5].z, -cb1[5].y
					add r0.y, -r0.y, cb0[8].z
					add r0.z, -cb0[8].y, cb0[8].z
			...
			Program "fp" {
				...
				SubProgram "d3d9 " {
					...
					//
					    ...
					    ps_3_0
					    def c12, 3.55539989, 0, -1.77769995, 1
					    def c13, 2, -1, 1, 100000000
					    def c14, 1.52587891e-005, 0.0671105608, 0.00583714992, 0
					    def c15, 0, 1, 12.9898005, 78.2330017
					    def c16, 0.00200000009, 9.99999975e-005, 0.600000024, 0
					    def c17, 6.28318548, -3.14159274, 0.159154937, 0.5
					    def c18, 1, 0.00392156886, 0, -0.999989986
					    def c19, 52.9829178, 12.451169, 0.5, 43758.5469
					    def c20, 0.5, -0.5, 0, 0
					    dcl_texcoord v0.xy
					    dcl_texcoord1 v1.xy
					    dcl_2d s0
					    ...
					    mad r0.xy, v0, c6, c6.zwzw
					    texld r1, r0, s1
					    mad r2.xyz, r1, c12.xxyw, c12.zzww
					    dp3 r0.z, r2, r2
					    rcp r0.z, r0.z
					    add r0.w, r0.z, r0.z
					    mul r2.yz, r2.xxyw, r0.w
					    mad r2.w, r0.z, c13.x, c13.y
					    mul_pp r3.xyz, r2.yzww, c13.zzyw
					    dp2add r0.z, r1.zwzw, c18, c18.z
					    cmp r1.xy, r0, c12.y, c12.w
					    dp2add r0.w, r1, r1, c12.y
					    add r0.xy, -r0, c12.w
					    cmp r0.xy, r0, c12.y, c12.w
					    dp2add r0.x, r0, r0, c12.y
					    cmp r0.xw, -r0, c12.y, c12.w
					    add r0.x, r0.x, r0.w
					    dp2add r0.y, r1.zwzw, c18, c18.w
					    cmp r0.y, r0.y, c12.w, c12.y
					    add r0.x, r0.y, r0.x
					    mul r0.x, r0.x, c13.w
					    mad r0.x, r0.z, c2.z, r0.x
					    mov r0.z, c2.z
					    mad r0.z, r0.z, -c14.x, r0.x
					    mad r1.xy, v1, c13.x, c13.y
					    mov r4.x, c0.z
					    mov r4.y, c1.z
					    add r1.xy, r1, -r4
					    rcp r5.x, c0.x
					    ...
					    mul r1.xy, r1, r5
					    add r0.w, -r0.z, c12.w
					    mad r0.w, c5.w, r0.w, r0.z
					    mul r0.xy, r0.w, r1
					    mul r1.xy, c10.x, v0
					    mul r1.xy, r1, c3
					    frc r1.zw, r1.xyxy
					    add r1.xy, -r1.zwzw, r1
					    dp2add r0.w, c14.yzzw, r1, c14.w
					    frc r0.w, r0.w
					    mul r0.w, r0.w, c19.x
					    frc r0.w, r0.w
					    rcp r1.x, c7.x
					    ...
					    rep i0
					      ...
					      add r1.w, r0.w, r1.w
					      frc r1.w, r1.w
					      mad r6.z, r1.w, c13.x, c13.y
					      mad r4.zw, r1.z, c15.xyxy, c15.xyzx
					      dp2add r1.w, r4.zwzw, c15.ywzw, c15.x
					      ...
					      dp3 r7.y, c1, r6
					      add r1.w, -r6.z, c12.w
					      mad r1.w, c5.w, r1.w, r6.z
					      rcp r1.w, r1.w
					      mad r4.zw, r7.xyxy, r1.w, c12.w
					      mul r5.zw, r4, c6.xyxy
					      mov r6.z, c19.z
					      mad r5.zw, r5, r6.z, c6
					      texld r6, r5.zwzw, s1
					      dp2add r1.w, r6.zwzw, c18, c18.z
					      cmp r6.xy, r5.zwzw, c12.y, c12.w
					      dp2add r2.x, r6, r6, c12.y
					      cmp r2.x, -r2.x, c12.y, c12.w
					      add r5.zw, -r5, c12.w
					      cmp r5.zw, r5, c12.y, c12.w
					      dp2add r3.w, r5.zwzw, r5.zwzw, c12.y
					      cmp r3.w, -r3.w, c12.y, c12.w
					      add r2.x, r2.x, r3.w
					      dp2add r3.w, r6.zwzw, c18, c18.w
					      cmp r3.w, r3.w, c12.w, c12.y
					      add r2.x, r2.x, r3.w
					      mul r2.x, r2.x, c13.w
					      mad r6.z, r1.w, c2.z, r2.x
					      add r4.zw, -r4.xyxy, r4
					    ...
					    mul_sat_pp r0.x, r0.y, r0.x
					    mul_pp oC0.x, r0.x, r1.x
					    mad_pp oC0.yzw, r2, c20.xxxy, c20.x
				...
				SubProgram "d3d11 " {
					...
					loop 
					  ...
					  mul r5.yz, r4.zzwz, l(0.000000, 0.500000, 0.500000, 0.000000)
					  mad r5.yz, r5.yyzy, cb0[4].xxyx, cb0[4].zzwz
					  sample r6.xyzw, r5.yzyy, t0.xyzw, s1
					  dp2 r1.w, r6.zwzz, l(1.000000, 0.003922, 0.000000, 0.000000)
					  lt r6.xy, r5.yzyy, l(0.000000, 0.000000, 0.000000, 0.000000)
					  or r2.x, r6.y, r6.x
					  and r2.x, r2.x, l(1)
				...
				SubProgram "d3d9 " {
					...
					// approximately 169 instruction slots used (3 texture, 166 arithmetic)"
				}
				SubProgram "d3d11 " {
					Keywords { "FOG_EXP" }
					"!!DX11PixelSM40
				...
				SubProgram "d3d9 " {
					...
					// approximately 170 instruction slots used (3 texture, 167 arithmetic)"
				}
				SubProgram "d3d11 " {
					Keywords { "FOG_EXP2" }
					"!!DX11PixelSM40
			...
			Program "fp" {
				...
				SubProgram "d3d9 " {
					...
					//
					    ...
					    ps_3_0
					    def c15, -0.999989986, 100000000, 52.9829178, 43758.5469
					    def c16, 0.0671105608, 0.00583714992, 0, 0.5
					    def c17, 0, 1, 12.9898005, 78.2330017
					    def c18, 12.451169, 0.5, 6.28318548, -3.14159274
					    def c19, 0.159154937, 0.5, 0.00200000009, 9.99999975e-005
					    def c20, -0, -1, 2, 1
					    def c21, 0.600000024, 0, 0, 0
					    dcl_texcoord v0.xy
					    dcl_texcoord1 v1.xy
					    dcl_2d s0
					    dcl_2d s1
					    ...
					    texld r1, r0, s0
					    dp3 r0.z, r1, r1
					    cmp r0.z, -r0.z, c20.x, c20.y
					    mad r1.xyz, r1, c20.z, r0.z
					    dp3_pp r2.y, c0, r1
					    dp3_pp r2.z, c1, r1
					    dp3_pp r2.w, c2, r1
					    texld r1, r0, s1
					    ...
					    rcp r1.x, r1.x
					    mul r1.z, r1.x, r1.y
					    cmp r3.xy, r0, -c20.x, -c20.y
					    dp2add r1.w, r3, r3, -c20.x
					    cmp r1.w, -r1.w, -c20.x, -c20.y
					    add r0.xy, -r0, c20.w
					    cmp r0.xy, r0, -c20.x, -c20.y
					    dp2add r0.x, r0, r0, -c20.x
					    cmp r0.x, -r0.x, -c20.x, -c20.y
					    add r0.x, r0.x, r1.w
					    mad r0.y, r1.y, r1.x, c15.x
					    cmp r0.y, r0.y, -c20.y, -c20.x
					    add r0.x, r0.y, r0.x
					    mul r0.x, r0.x, c15.y
					    mad r1.z, r1.z, c5.z, r0.x
					    mad r0.xy, v1, c20.z, c20.y
					    mov r3.x, c3.z
					    mov r3.y, c4.z
					    add r0.xy, r0, -r3
					    rcp r4.x, c3.x
					    ...
					    rep i0
					      ...
					      add r1.w, r0.x, r1.w
					      frc r1.w, r1.w
					      mad r5.z, r1.w, c20.z, c20.y
					      mad r4.zw, r3.w, c17.xyxy, c17.xyzx
					      dp2add r1.w, r4.zwzw, c17.ywzw, c17.x
					      ...
					      mad r1.w, c8.w, r1.w, r5.z
					      rcp r1.w, r1.w
					      mad r4.zw, r6.xyxy, r1.w, c20.w
					      mul r5.xy, r4.zwzw, c16.w
					      mad r5.xy, r5, c9, c9.zwzw
					      texld r6, r5, s1
					      mul r1.w, r6.x, c7.x
					      mad r2.x, c8.w, -r1.w, r0.w
					      mad r1.w, r0.z, r1.w, c7.y
					      rcp r1.w, r1.w
					      mul r5.z, r1.w, r2.x
					      cmp r6.xy, r5, -c20.x, -c20.y
					      dp2add r5.w, r6, r6, -c20.x
					      add r5.xy, -r5, c20.w
					      cmp r5.xy, r5, -c20.x, -c20.y
					      dp2add r5.x, r5, r5, -c20.x
					      cmp r5.xw, -r5, -c20.x, -c20.y
					      add r5.x, r5.x, r5.w
					      mad r1.w, r2.x, r1.w, c15.x
					      cmp r1.w, r1.w, -c20.y, -c20.x
					      add r1.w, r1.w, r5.x
					      mul r1.w, r1.w, c15.y
					      mad r5.z, r5.z, c5.z, r1.w
					    ...
					    add r0.x, -r0.x, c14.z
					    add r0.y, -c14.y, c14.z
					    rcp r0.y, r0.y
					    mul_sat_pp r0.x, r0.y, r0.x
					    mul_pp oC0.x, r0.x, r1.x
					    mad_pp oC0.yzw, r2, c16.w, c16.w
				...
				SubProgram "d3d9 " {
					...
					// approximately 172 instruction slots used (4 texture, 168 arithmetic)"
				}
				SubProgram "d3d11 " {
					Keywords { "FOG_EXP" }
					"!!DX11PixelSM40
			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    pow_pp r1.x, r0.x, c3.z
					    mad_pp r0.x, r1.x, c4.x, c4.y
					    add r0.y, -r0.x, -c2.y
					    add r0.y, -r0.y, -c2.y
					    texld_pp r1, v0, s0
					    mul_pp r0.yzw, r0.y, r1.xxyz
					    mov_pp oC0.w, r1.w
					    cmp_pp oC0.xyz, r0.x, r0.yzww, c3.w
			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    mad_pp r0.z, r0.y, -r0.x, -c3.x
					    mul_pp r0.x, r0.x, r0.y
					    mov_pp oC0.w, r0.x
					    pow_pp r1.x, r0.z, c2.z
					    mad_pp r0.x, r1.x, c4.x, c4.y
					    add_pp r0.y, -r0.x, -c3.x
					    cmp_pp oC1.xyz, r0.x, r0.y, -c3.x
					    mov_pp oC0.xyz, c2.w
					    mov_pp oC1.w, c2.w
				...
				SubProgram "d3d11 " {
					...
					mad r0.x, r0.x, l(1.055000), l(-0.055000)
					max r0.x, r0.x, l(0.000000)
					add o1.xyz, -r0.xxxx, l(1.000000, 1.000000, 1.000000, 0.000000)
